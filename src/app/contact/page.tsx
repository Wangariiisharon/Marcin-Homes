          ...
          <ul className="mt-12 space-y-6">
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="font-display text-2xl">+1 (212) 555 0140</p>
              </div>
            </li>
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="font-display text-2xl">concierge@marcinhomes.co</p>
              </div>
            </li>
            <li className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="font-display text-2xl">14 Greene Street, Floor 3</p>
                <p className="text-sm text-foreground/70">New York, NY 10013</p>
              </div>
            </li>
          </ul>
        </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              ...
              >
                ...
                <option>Buying or leasing a home</option>
                <option>Selling or listing a home</option>
                <option>Property management</option>
                <option>24-hour home services</option>
                <option>Other</option>
              </select>
            </div>
            <div className="sm:col-span-2">
